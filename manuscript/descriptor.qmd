...
- Define "vintage" explicitly at first use (plain-language definition in
  docs/releases.md; cite the Croushore/Stark real-time-data lineage) —
  never assume the reader knows the term.
